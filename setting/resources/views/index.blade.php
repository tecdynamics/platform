@php
    ...
    if (BaseHelper::hasDemoModeEnabled() && session('site-locale') && array_key_exists(session('site-locale'), \Tec\Base\Supports\Language::getAvailableLocales())) {
        $defaultLocale = session('site-locale');
    }

    $locales = collect(\Tec\Base\Supports\Language::getAvailableLocales())
        ->pluck('name', 'locale')

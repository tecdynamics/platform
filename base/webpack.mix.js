...
mix
    ...
    .js(source + '/resources/assets/js/admin_duplicate.js', dist + '/js')
...
mix
    .copy('node_modules/jquery/dist/jquery.min.js', dist + '/libraries/jquery.js')
    // .copy('node_modules/jquery/dist/jquery.min.js', dist + '/libraries/jquery.min.js')
    .copy(mix.inProduction() ? './node_modules/vue/dist/vue.common.prod.js' : './node_modules/vue/dist/vue.js',
        `${dist}/libraries/vue.js`
...
if (mix.inProduction()) {
    mix
        ...
        .copy(dist + '/libraries/jquery.js', source + '/public/libraries/jquery.js')
        //.copy(dist + '/libraries/jquery.min.js', source + '/public/libraries/jquery.min.js')
       .copy(dist + '/libraries/vue.js', source + '/public/libraries/vue.js')

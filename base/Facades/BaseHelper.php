 ...
 * @method static \Tec\Base\Helpers\BaseHelper iniSet(string $key, string|int|null $value)
 * @method static \Tec\Base\Helpers\BaseHelper maximumExecutionTimeAndMemoryLimit()

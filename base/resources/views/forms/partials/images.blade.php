<div class="gallery-images-wrapper list-images">
    ...
    <div class="images-wrapper">
        <div data-name="{{ $name }}"
             ...
             <img  loading="lazy" src="{{ RvMedia::getDefaultImage(false) }}" alt="{{ trans('core/base::base.image') }}" width="120">
            <br>
                            ...
                            <div class="custom-image-box image-box">
                                <input type="hidden" name="{{ $name }}" value="{{ $image }}" class="image-data">
                                    <div class="preview-image-wrapper @if (!Arr::get($attributes, 'allow_thumb', true)) preview-image-wrapper-not-allow-thumb @endif">
                                     <img  loading="lazy" src="{{ RvMedia::getImageUrl($image, Arr::get($attributes, 'allow_thumb', true) == true ? 'thumb' : null) }}" alt="{{ trans('core/base::base.preview_image') }}"
                                         class="preview_image">
                                </div>
                            </div>
                        </li>
        ...
        <script id="gallery_select_image_template" type="text/x-custom-template">
            ...
            <div class="custom-image-box image-box">
                <input type="hidden" name="__name__" class="image-data">
                 <img  loading="lazy" src="{{ RvMedia::getDefaultImage(false) }}" alt="{{ trans('core/base::base.preview_image') }}" class="preview_image">

...
class PendingRequest {
    ...
    withButtonLoading(element) {
        this.beforeSend(() => Tec.showButtonLoading(element))
        this.completed(() => Tec.hideButtonLoading(element))

        return this
    }

    withLoading(element) {
        this.beforeSend(() => Tec.showLoading(element))
        this.completed(() => Tec.hideLoading(element))

            ...
            <div class="w-100 gap-2 d-block d-md-flex align-items-start justify-content-between flex-wrap">
                <div class="d-block d-md-flex gap-2">
                    @if ($table->hasBulkActions())
                        <x-core::dropdown
                            ...
                            wrapper-class="d-inline-block mb-1"
                        >
                ...
                <div class="d-block d-md-flex gap-2 mb-1">
                    @foreach($table->getButtons() as $button)
                        ...
                        @else
                            <button class="mb-1 btn {{ $button['className'] }}" tabindex="0" aria-controls="{{ $table->getOption('id') }}" type="button" aria-haspopup="dialog" aria-expanded="false">
                                {!! $button['text'] !!}
                            </button>
                        @endif
                    @endforeach

...
(function ($, DataTable) {
  ...
  DataTable.ext.buttons.excel = {
    ...
    text: function text(dt) {
      return '<i class="far fa-file-excel"></i> ' + dt.i18n('buttons.excel', TecVariables.languages.tables.excel ? TecVariables.languages.tables.excel : 'Excel');
    },
  ...
  DataTable.ext.buttons["export"] = {
    ...
    text: function text(dt) {
      return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', TecVariables.languages.tables["export"] ? TecVariables.languages.tables["export"] : 'Export') + '&nbsp;<span class="caret"/>';
    },
    buttons: ['csv', 'excel']
  };
  DataTable.ext.buttons.csv = {
    ...
    text: function text(dt) {
      return '<i class="fas fa-file-csv"></i> ' + dt.i18n('buttons.csv', TecVariables.languages.tables.csv ? TecVariables.languages.tables.csv : 'CSV');
    },
    action: function action(e, dt) {
  ...
  DataTable.ext.buttons.print = {
    ...
    text: function text(dt) {
      return '<i class="fa fa-print"></i> ' + dt.i18n('buttons.print', TecVariables.languages.tables.print ? TecVariables.languages.tables.print : 'Print');
    },
    action: function action(e, dt) {
  ...
  DataTable.ext.buttons.reset = {
    ...
    text: function text(dt) {
      return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', TecVariables.languages.tables.reset ? TecVariables.languages.tables.reset : 'Reset');
    },
  ...
  DataTable.ext.buttons.reload = {
    ...
    text: function text(dt) {
      return '<i class="fas fa-sync"></i> ' + dt.i18n('buttons.reload', TecVariables.languages.tables.reload ? TecVariables.languages.tables.reload : 'Reload');
    },
    action: function action(e, dt) {
      dt.draw(false);
    }
    ...
    _createClass(TableManagement, [{
      ...
      value: function handleActionsRow() {
        ...
        $(document).on('click', '.delete-many-entry-trigger', function (event) {
          ...
          if (ids.length === 0) {
            Tec.showError(TecVariables.languages.tables.please_select_record ? TecVariables.languages.tables.please_select_record : 'Please select at least one record to perform this action!');
            return false;
          }

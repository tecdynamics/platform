 ...
 * @method static \Tec\Media\RvMedia addSize(string $name, string|int $width, string|int $height = 'auto')
 * @method static \Tec\Media\RvMedia removeSize(string $name)
 ...
 * @method static bool generateThumbnails(\Tec\Media\Models\MediaFile $file, \Illuminate\Http\UploadedFile|null $fileUpload = null)

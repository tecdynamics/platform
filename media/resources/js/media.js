    ...
    handleModals() {
        ...
        _self.$body
            ...
            .on('click', '#modal-properties button[type="submit"]', (event) => {
                ...
                Tec.showButtonLoading($modal.find('button[type="submit"]'))
                ...
                ActionsService.processAction(
                    ...
                    () => {
                        $modal.modal('hide')
                        Tec.hideButtonLoading($modal.find('button[type="submit"]'))
        ...
        _self.$body
            ...
            .on('submit', '#modal_crop_image .form-crop', (event) => {
                ...
                Tec.showButtonLoading($form.find('button[type="submit"]'))
                ...
                ActionsService.processAction(
                    ...
                    (response) => {
                        ...
                        Tec.hideButtonLoading($form.find('button[type="submit"]'))
                    }
                )
            })

 ...
 * @method static \Tec\Base\Supports\EmailHandler setType(string $type)
 * @method static string|null getTemplate()
 * @method static \Tec\Base\Supports\EmailHandler setTemplate(string|null $template)
 * @method static array getCoreVariables()
 * @method static string getCssContent()
 * @method static array getIconVariables()
 * @method static \Tec\Base\Supports\EmailHandler setVariableValue(string $variable, array|string|null $value, string|null $module = null)
 * @method static array getVariableValues(string|null $module = null)
 * @method static \Tec\Base\Supports\EmailHandler setVariableValues(array $data, string|null $module = null)
 * @method static \Tec\Base\Supports\EmailHandler addTemplateSettings(string $module, array|null $data, string $type = 'plugins')
 ...
 *
 * @see \Tec\Base\Supports\EmailHandler
 */

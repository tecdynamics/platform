...
use Tec\Base\Exceptions\CouldNotConnectToLicenseServerException;
...
use Tec\Base\Exceptions\MissingZipExtensionException;
...
final class Core
{
    ...
    private string $licenseUrl = 'https://license.tecdynamics.co.uk';

    private string $licenseKey = 'TEC4B17F6D3FESHOP656125F9';

    private string $cacheLicenseKeyName = '45d0da541764682476f833028d945a46270gg55';

    private string $skipLicenseReminderFilePath;

    private int $verificationPeriod = 10;
